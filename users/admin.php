  ...
  <div class="container"> <!-- -fluid -->
    ...
    <div class="row row-centered">
      ...
      <a href="<?=$us_url_root?>users/admin_permissions.php"><div class="col-md-1 col-sm-3 col-xs-6 col-centered">
        <div class="panel panel-default">
          <i class="fa fa-lock fa-2x"></i><br>Manage<br>Permissions</li>
        </div>
      </div></a>
...
<?php if(in_array($user->data()->id,$master_account)){ ?>
      ...
      <a href="<?=$us_url_root?>users/admin_forms.php"><div class="col-md-1 col-sm-3 col-xs-6 col-centered">
        <div class="panel panel-default">
          <i class="fa fa-pencil-square-o  fa-2x"></i><br>Manage<br>Forms</li>
        </div>
      </div></a>
<?php } //end master account buttons?>
      ...
      <a href="<?=$us_url_root?>users/email_settings.php"><div class="col-md-1 col-sm-3 col-xs-6 col-centered">
        <div class="panel panel-default">
          <i class="fa fa-paper-plane fa-2x"></i><br>Email<br>Settings</li>
        </div>
      </div></a>
      <br>
