...
if($act == 1) {
	require $abs_us_root.$us_url_root.'lms_master/users/views/_joinThankYou_verify.php';
}else{
	require $abs_us_root.$us_url_root.'lms_master/users/views/_joinThankYou.php';
}
