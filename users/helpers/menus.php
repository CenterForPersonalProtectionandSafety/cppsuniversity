...
function prepareItemString($menuItem,$user_id){
	...
	elseif($menuItem['link']=='lms_master/users/verify_resend.php' || $menuItem['link']=='lms_master/usersc/verify_resend.php') {
		$db = DB::getInstance();
	...
	elseif($menuItem['link']=='lms_master/users/join.php' || $menuItem['link']=='lms_master/usersc/join.php') {
		$db = DB::getInstance();
