...
<?php require_once $abs_us_root.$us_url_root.'usersc/includes/navigation_right_side.php'; ?>
					...
					<li class="dropdown hidden-xs"><a class="dropdown-toggle" href="<?=$us_url_root?>users/admin.php" data-toggle="dropdown"><i class="fa fa-fw fa-cog"></i><b class="caret"></b></a> <!-- regular user menu -->
